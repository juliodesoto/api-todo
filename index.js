// Esto es el backend y tiene que estar siemore vivo, en la consola hay que poner el node index.js cada vez que se haga un cambio
...
servidor.get("/tareas", async (peticion,respuesta) => {
    try{let tareas = await leerTareas();
